...
def inference_batch_norm_vgg16_head_tail_scratch(inputs):
    ...
    shortcut4 = snt.Conv2D(output_channels=128,
                        kernel_shape=3,
                        stride=1,
                        padding='SAME',
                        name='conv2_0')(inputs)
    ...
    shortcut8 = snt.Conv2D(output_channels=256,
                        kernel_shape=3,
                        stride=1,
                        padding='SAME',
                        name='conv3_0')(inputs)
    ...
    shortcut14 = snt.Conv2D(output_channels=512,
                        kernel_shape=3,
                        stride=1,
                        padding='SAME',
                        name='conv4_0')(inputs)
    ...
    inputs = tf.nn.avg_pool(inputs, [1, 2, 2, 1], [1, 2, 2, 1], padding='SAME')
