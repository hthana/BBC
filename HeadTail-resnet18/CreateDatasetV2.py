...
parser.add_argument('--data_dir', default='datasets/HT_coord/',
                    help="Directory containing the dataset")
...
print("seed: ", seed)
CROP = True
dataset_path = os.path.join('./Body-Bend-Analysis/HeadTail-resnet18/datasets/',args.data_dir)
if os.path.exists(dataset_path):
    os.rmdir(dataset_path)

input_files_dir = './Body-Bend-Analysis/HeadTail-resnet18/datasets/HT_coord/HeadTailImagesXY/'
